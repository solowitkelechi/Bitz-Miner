# Bitz-Miner
# Detailed guide to run Bitz miner on Android
...
> Prerequisites for installing Linux Ubuntu
- [Highend Android Device: Android 7.0+ recommended (proot-distro has issues below 7). At least 8GB RAM and Enough storage.] 
